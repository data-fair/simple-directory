...
Peut valoir 'anonymous', 'authenticated' ou 'admin'.`,
  ...
  pages: {
    ...
    login: {
      ...
      separateDomain: 'Le site {redirectHost} fait partie de la plateforme <a href="{mainHost}">{mainHost}</a>. Votre compte est mutualisé avec tous les sites de cette plateforme.',
