...
Peut valoir 'anonymous', 'authenticated' ou 'admin'.`,
  ...
  pages: {
    ...
    login: {
      ...
      separateDomain: 'Vous vous apprêtez à créer un compte sur <a href="{host}">{host}</a>, ce site fait partie de la plateforme <a href="mainHost">{mainHost}</a>. Le compte sera mutualisé avec tous les sites de cette plateforme.',
