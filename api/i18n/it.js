...
export default {
  ...
  common: {
    manageNotifications: 'Gestire le notifiche',
    ...
    passwordShown: 'La tua password è visibile',
    passwordHidden: 'La tua password è nascosta',
  ...
  pages: {
    admin: {
      users: {
        ...
        editUserEmailTitle: 'Cambiare l\'indirizzo email dell\'utente {name}',
    ...
    login: {
      ...
      passwordlessMsg2: "Inviare un'e-mail di login.",
      ...
      createUserMsg2: 'Creare un account',
      ...
      createUserConfirm: 'Creare un account',
      ...
      configure2FA: 'Configurare l\'autenticazione a due fattori',
      ...
      recovery2FAInfo: 'Attenzione! Conserva il codice di recupero sottostante in un luogo sicuro. Senza di esso, non sarai in grado di recuperare il tuo account se perdi il dispositivo su cui hai appena impostato l\'autenticazione a due fattori.',
      recovery2FACode: 'codice di recupero: ',
      recovery2FADownload: 'scaricare un file contenente il codice di recupero',
    ...
    organization: {
      ...
      confirmEditMemberTitle: 'Modificare {name}',
      ...
      editDepartment: 'Modificare {departmentLabel}',
      deleteDepartment: 'Cancellare {departmentLabel}',
      confirmEditDepartmentTitle: 'Modificare {name}',
      ...
      sendInvitationLink: 'Inviare un altro link di invito',
      addPartner: 'Invitare un\'organizzazione partner',
      ...
      nhisHelp: 'Gli account di servizio si autenticano con un token rilasciato da un provider di identità affidabile (ad esempio un cluster Kubernetes). Non hanno un\'e-mail e le loro sessioni sono di breve durata.',
      addNhi: 'Crea un account di servizio',
      editNhi: 'Modifica l\'account di servizio',
      deleteNhi: 'Elimina l\'account di servizio',
      confirmDeleteNhiTitle: 'Elimina l\'account di servizio {name}',
      confirmDeleteNhiMsg: 'Vuole davvero eliminare questo account di servizio? I token in corso smetteranno di funzionare una volta scaduti.',
      nhiIssuer: 'Emittente del token',
      nhiSubject: 'Soggetto',
      nhiAllowedIps: 'Indirizzi autorizzati (opzionale)',
      nhiAllowedIpsHint: 'Indirizzi o sottoreti CIDR da cui lo scambio di token è accettato, per esempio 203.0.113.5 o 10.4.0.0/16. Lasciare vuoto per accettare qualsiasi indirizzo.',
      nhiIpBinding: "Vincolare la sessione all'indirizzo da cui è stata ottenuta",
      nhiIpBindingHint: 'Un token trafugato diventa inutilizzabile altrove. Attivare solo se questo account di servizio chiama sempre da un indirizzo stabile: un indirizzo di uscita variabile (pool NAT, dual-stack) interromperebbe le sue sessioni.',
      nhiJwks: 'JWKS (opzionale, se il provider non è raggiungibile pubblicamente)',
      nhiClientId: 'Identificativo client (client_id)',
      nhiJwksInvalid: 'JSON non valido per il JWKS: {message}'
    },
    invitation: {
    ...
    avatar: {
      changeUser: 'Cambiare l\'avatar del tuo account',
      changeOrganization: 'Cambiare l\'avatar dell\'organizzazione',
      changeDepartment: 'Cambiare l\'avatar di "{departmentName}"',
      reset: 'Ripristinare l\'avatar predefinito'
    },
    me: {
      ...
      deleteMyselfAlert: 'Se si cancella il proprio account, si dispone di {plannedDeletionDelay} giorni per annullare l\'operazione, dopodiché tutti i dati associati saranno cancellati e non potranno essere recuperati.',
      deleteMyselfCheck: 'selezionare questa casella e fare clic su OK per confermare la cancellazione dell\'utente {name} e di tutti i suoi dati.',
...
Non esitate a contattarci a {contact}.
      ...
      htmlButton: 'Accedere per annullare la cancellazione',
