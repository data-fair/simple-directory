...
Peut valoir 'anonym', 'authentifiziert' oder 'admin'.`,
  ...
  pages: {
    ...
    login: {
      ...
      revovery2FAInfo: 'Achtung! Bewahren Sie den Wiederherstellungscode unten an einem sicheren Ort auf. Ohne ihn können Sie Ihr Konto nicht wiederherstellen, wenn Sie das Gerät verlieren, auf dem Sie gerade die Zwei-Faktor-Authentifizierung eingerichtet haben.',
