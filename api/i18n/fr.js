...
Peut valoir 'anonymous', 'authenticated' ou 'admin'.`,
  ...
  pages: {
    ...
    avatar: {
      loadUser: 'Charger votre avatar',
      loadOrganization: 'Charger un avatar d\'organisation',
      loadDepartment: 'Charger un avatar ({departmentLabel})',
      prepare: 'Préparer l\'image'
    },
    me: {
